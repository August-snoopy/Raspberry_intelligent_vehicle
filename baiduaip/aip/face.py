...
class AipFace(AipBase):
    ...
    def detect(self, image, image_type, options=None):
        ...
        data.update(options)
        return self._request(self.__detectUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
    ...
    def search(self, image, image_type, group_id_list, options=None):
        ...
        data.update(options)
        return self._request(self.__searchUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def multiSearch(self, image, image_type, group_id_list, options=None):
        ...
        data.update(options)
        return self._request(self.__multiSearchUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def addUser(self, image, image_type, group_id, user_id, options=None):
        ...
        data.update(options)
        return self._request(self.__userAddUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def updateUser(self, image, image_type, group_id, user_id, options=None):
        ...
        data.update(options)
        return self._request(self.__userUpdateUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceDelete(self, user_id, group_id, face_token, options=None):
        ...
        data.update(options)
        return self._request(self.__faceDeleteUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def getUser(self, user_id, group_id, options=None):
        ...
        data.update(options)
        return self._request(self.__userGetUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceGetlist(self, user_id, group_id, options=None):
        ...
        data.update(options)
        return self._request(self.__faceGetlistUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def getGroupUsers(self, group_id, options=None):
        ...
        data.update(options)
        return self._request(self.__groupGetusersUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def userCopy(self, user_id, options=None):
        ...
        data.update(options)
        return self._request(self.__userCopyUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def deleteUser(self, group_id, user_id, options=None):
        ...
        data.update(options)
        return self._request(self.__userDeleteUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def groupAdd(self, group_id, options=None):
        ...
        data.update(options)
        return self._request(self.__groupAddUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def groupDelete(self, group_id, options=None):
        ...
        data.update(options)
        return self._request(self.__groupDeleteUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def getGroupList(self, options=None):
        ...
        data.update(options)
        return self._request(self.__groupGetlistUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def videoSessioncode(self, options=None):
        ...
        data.update(options)
        return self._request(self.__videoSessioncodeUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceverify(self, images):
        ...
        return self._request(self.__faceverifyUrl, json.dumps(images, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def match(self, images):
        ...
        return self._request(self.__matchUrl, json.dumps(images, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceMingJingVerify(self, id_card_number, name, image, options=None):
        ...
        data.update(options)
        return self._request(self.__verifyUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'),
    ...
    def faceMingJingMatch(self, image, imageType, registerImage, registerImageType, options=None):
        ...
        data.update(options)
        return self._request(self.__faceMatchUrlV4, json.dumps(data, ensure_ascii=False).encode('utf-8'),
                             {'Content-Type': 'application/json;charset=utf-8'})
    ...
    def onlinePictureLiveV4(self, sdkVersion, options=None):
        ...
        data.update(options)
        return self._request(self.__onlinePictureLiveV4, json.dumps(data, ensure_ascii=False).encode('utf-8'),
                             {'Content-Type': 'application/json;charset=utf-8'})
    ...
    def facePersonIdmatchV3(self, id_card_number, name, options=None):
        ...
        data['name'] = name
        data.update(options)
        return self._request(self.__facePersonIdmatchV3Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceMergeV1(self, image_template, image_target, options=None):
        ...
        data.update(options)
        return self._request(self.__faceMergeV1Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceSkinSmoothV1(self, image, image_type, action_type, options=None):
        ...
        data.update(options)
        return self._request(self.__faceSkinSmoothV1Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceLandmarkV1(self, image, image_type, options=None):
        ...
        data['image_type'] = image_type
        data.update(options)
        return self._request(self.__faceLandmarkV1Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceSceneFacesetUserAdd(self, image, image_type, group_id, user_id, scene_type, options=None):
        ...
        data.update(options)
        return self._request(self.__faceSceneFacesetUserAddUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceSceneFacesetUserUpdate(self, image, image_type, group_id, user_id, scene_type, options=None):
        ...
        data['scene_type'] = scene_type
        data.update(options)
        return self._request(self.__faceSceneFacesetUserUpdateUrl,
    ...
    def faceSceneFacesetGroupAdd(self, group_id, scene_type, options=None):
        ...
        data['scene_type'] = scene_type
        data.update(options)
        return self._request(self.__faceSceneFacesetGroupAddUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceCaptureSearch(self, image, image_type, group_id_list, options=None):
        ...
        data['group_id_list'] = group_id_list
        data.update(options)
        return self._request(self.__faceCaptureSearchUrl, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceIdmatchDateV4(self, name, id_card_number, start_date, end_date, options=None):
        ...
        data.update(options)
        return self._request(self.__faceIdmatchDateV4Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
    ...
    def faceVerifyDateV4(self, name, id_card_number, start_date, end_date, image, image_type, options=None):
        ...
        data['image_type'] = image_type
        data.update(options)
        return self._request(self.__faceVerifyDateV4Url, json.dumps(data, ensure_ascii=False).encode('utf-8'), {
            'Content-Type': 'application/json',
        })
