...
class AipImageCensor(AipBase):
    ...
    __documentCensorSubmitUrl = "https://aip.baidubce.com/rest/2.0/solution/v1/solution/document/v1/submit"

    __documentCensorPullUrl = "https://aip.baidubce.com/rest/2.0/solution/v1/solution/document/v1/pull"
    ...
    def documentCensorUrlSubmit(self, file_name, url, options=None):
        """
            文档审核-提交任务(URL)
        ...
        data['url'] = url
        data.update(options)
        return self._request(self.__documentCensorSubmitUrl, data)

    def documentCensorFileSubmit(self, file_name, document, options=None):
        """
            文档审核-提交任务(Base64)
            https://ai.baidu.com/ai-doc/ANTIPORN/2l8484xvl
        """
        ...
        options = options or {}
        data['fileName'] = file_name
        data['fileBase64'] = base64.b64encode(document).decode()
        data.update(options)
        return self._request(self.__documentCensorSubmitUrl, data)

    def documentCensorPull(self, task_id, options=None):
        """
            文档审核-拉取结果
        ...
        data['taskId'] = task_id
        data.update(options)
        return self._request(self.__documentCensorPullUrl, data)